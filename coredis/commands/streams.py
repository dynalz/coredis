...
class StreamsCommandMixin(CommandMixin):
    ...
    async def xadd(
        self, key: str, entry: dict, max_len=None, stream_id="*", approximate=True
    ) -> str:
        """
    ...
    async def xtrim(self, key: str, max_len: int, approximate=True) -> int:
        """
    ...
    async def xdel(self, key: str, stream_id: str) -> int:
        """
    ...
    async def xinfo_stream(self, key: str) -> Dict:
        ...
        return await self.execute_command("XINFO STREAM", key)

    async def xack(self, key: str, group: str, stream_id: str) -> int:
        """
        ...
        return await self.execute_command("XACK", key, group, stream_id)

    async def xclaim(
        self, key: str, group: str, consumer: str, min_idle_time: int, *stream_ids
    ):
        """
        ...
        return await self.execute_command(
            "XCLAIM", key, group, consumer, min_idle_time, *stream_ids
        )

    async def xgroup_create(self, key: str, group: str, stream_id="$") -> bool:
        """
        ...
        return await self.execute_command("XGROUP CREATE", key, group, stream_id)

    async def xgroup_set_id(self, key: str, group: str, stream_id: str) -> bool:
        """
        :param key: name of the stream
        :param group: name of the consumer group
        :param stream_id:
        ...
        return await self.execute_command("XGROUP SETID", key, group, stream_id)
    ...
    async def xgroup_destroy(self, key: str, group: str) -> int:
        ...
        return await self.execute_command("XGROUP DESTROY", key, group)

    async def xgroup_del_consumer(self, key: str, group: str, consumer: str) -> int:
        """
        XGROUP is used in order to create, destroy and manage consumer groups.
        ...
        return await self.execute_command("XGROUP DELCONSUMER", key, group, consumer)
